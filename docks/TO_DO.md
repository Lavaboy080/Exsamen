...
- [x] Lage breakoutsppillet
  ...
  - [x] Lage en ball som flytter seg
  - [x] Få ballen til å sprette av høyre, venstre og øverste vegg
  - [x] Programere game over når ballen treffer bunnen
  - [x] Lage blokkene med enkel variabel for å definere hvor mange
  - [x] Gi blokkene kollisoner
  - [x] Få blokkene til å forsvinne når de blir truffet
